...
namespace ChatAppBackCore
{
    ...
    options.UseSqlServer(Configuration.GetConnectionString("SQLServer")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ChatAppBackCore", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ChatAppBackCore v1"));
            }
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                //endpoints.MapHub<TodoListHub>("/chat");
            });
        }
    }
}
